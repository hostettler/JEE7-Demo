...
const styles: string = 'app/date-picker/css/mydatepicker.css';
const template: string = 'app/date-picker/template/mydatepicker.html';
...
export class MyDatePicker implements OnInit, OnChanges {
    ...
    ngOnChanges(changes: {[propName: string]: SimpleChange}) {
        this.selectionDayTxt = this.formatDate(changes['selDate'].currentValue);
